...
def _load_single_dataset(
    ...
    if dataset_attr.load_from == "ms_hub":
        ...
        if dataset_attr.dataset_name == "dataset_mix.parquet" and dataset_attr.split == "train":
            from .fim import fim_transform
            dataset = dataset.map(lambda x:{'content':fim_transform(x)})
